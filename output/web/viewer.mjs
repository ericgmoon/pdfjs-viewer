...
class BasePreferences {
  #defaults = Object.freeze({
    ...
    highlightEditorColors: "red=#FF4F5F,yellow=#FFFF98,green=#53FFBC,blue=#80EBFF,pink=#FFCBE6",
    ...
    switch (evt.keyCode) {
      ...
      case 84:
        pdfViewer.annotationEditorMode = {
          source: window,
          mode: pdfViewer.annotationEditorMode === AnnotationEditorType.FREETEXT ? AnnotationEditorType.NONE : AnnotationEditorType.FREETEXT
        };
        handled = true;
        break;
      case 76:
        pdfViewer.annotationEditorMode = {
          source: window,
          mode: pdfViewer.annotationEditorMode === AnnotationEditorType.HIGHLIGHT ? AnnotationEditorType.NONE : AnnotationEditorType.HIGHLIGHT,
          isFromKeyboard: true
        };
        handled = true;
        break;
      case 73:
        pdfViewer.annotationEditorMode = {
          source: window,
          mode: pdfViewer.annotationEditorMode === AnnotationEditorType.INK ? AnnotationEditorType.NONE : AnnotationEditorType.INK,
          isFromKeyboard: true
        };
        handled = true;
        break;
